...
public class GraphAlgorithms {
     ...
     *
     */
    public static <V,E> LinkedList<V> BFS( Graph<V,E> graph, V vertex) {
     ...
     */
    public static <V,E> LinkedList<V> DFS( Graph<V,E> graph, V vertex) {
     ...
     *
     */
    static <V,E> void DFS( Graph<V,E> graph, int index, LinkedList<V> verticesQueue) {
    		throw new UnsupportedOperationException("Not supported yet.");	
    }
     ...
     */
    public static <V, E> Graph<V, E> transitiveClosure(Graph<V, E> graph, E dummyEdge){
            throw new UnsupportedOperationException("Not supported yet.");	
    }
